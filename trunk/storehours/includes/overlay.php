			...
			<div class='warning' id='warning'>
				...
				<div class='body'>
					...
					<div style='margin-top: 20px; '><strong>Are you sure you want to do this? It cannot be undone!</strong><br />
						<input type='button' value='Yes' onclick="javascript:delItem('<?=$BF?>calendar/includes/ajax_delete.php?postType=<?=$postType?>&tbl=<?=$tableName?>&idUser=<?=$_SESSION['idUser']?>&id=');" /> &nbsp;&nbsp; <input type='button' value='No' onclick="javascript:revert();" />
					</div>
				</div>
			</div>
		</div>
