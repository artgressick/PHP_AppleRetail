						...
						<form id="form1" name="form1" method="post" action="">
							<table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									<td>
									<?=messages()?>
									<?=form_text(array('caption'=>'Apple Email Address','required'=>'true','value'=>(isset($_REQUEST['auth_form_name']) ? $_REQUEST['auth_form_name'] : ''),'name'=>'auth_form_name','size'=>'30','maxlength'=>'35'))?>
