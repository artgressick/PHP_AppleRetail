										...
										<table width="100%" class="twoCol" id="twoCol" cellpadding="0" cellspacing="0">
											<tr>
												<td class="tcleft">
													...
													<? //form_select(array(1=>'New Store Opening',2=>'Re-Model'),array('caption'=>'NSO Category','name'=>'idNSOCategory'))?>

													<?=form_text(array('caption'=>'NSO/Remodel Type Name','required'=>'true','name'=>'chrNSOType','size'=>'35','maxlength'=>'120'))?>
