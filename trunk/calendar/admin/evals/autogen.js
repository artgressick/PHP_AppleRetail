...
function addNew() {
	...
	'		<td class="loption"><select name="idEvalCat'+ num.value +'" id="idEvalCat"'+ num.value +'">'+ eval_cats +'</td>' +
	...
	'		<td class="loption"><select name="idEvalType'+ num.value +'" id="idEvalType'+ num.value +'" onchange="showOptions(this.value,'+ num.value +')">'+ eval_types +'</td>' +
	'		<td class="rheader">&nbsp;</td>' +
	'		<td class="roption">&nbsp;</td>' +
	'	</tr>' +
	'	<tr>' +
