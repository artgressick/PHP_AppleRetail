<?
	...
	$table = 'NSOFileTypes'; # added so not to forget to change the insert AND audit

	$q = "INSERT INTO ". $table ." SET 
		chrKEY = '". makekey() ."',
		chrNSOFileType = '". encode($_POST['chrNSOFileType']) ."'
	";
	...
	if(db_query($q,"Insert into ". $table)) {
		...
		$_SESSION['infoMessages'][] = "File Type: ".$_POST['chrNSOFileType']." has been added successfully.";
