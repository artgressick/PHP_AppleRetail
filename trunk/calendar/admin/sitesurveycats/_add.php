<?
	...
	$table = 'SSCats'; # added so not to forget to change the insert AND audit

	$next = db_query("SELECT intOrder FROM SSCats WHERE !bDeleted ORDER by intOrder DESC","Getting Next IntOrder",1);
	...
	if(db_query($q,"Insert into ". $table)) {
		...
		$_SESSION['infoMessages'][] = "Site Survey Category: ".$_POST['chrCat']." has been added successfully.";
