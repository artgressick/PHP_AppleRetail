<?
	...
	list($mysqlStr,$audit) = set_strs($mysqlStr,'chrCalendarType',$info['chrCalendarType'],$audit,$table,$info['ID']);
	...
	if($mysqlStr != '') { 
		$_SESSION['infoMessages'][] = $_POST['chrCalendarType']." has been successfully updated in the Database.";
		list($str,$aud) = update_record($mysqlStr, $audit, $table, $info['ID']);
	 } else {
	 	$_SESSION['infoMessages'][] = "No Changes have been made to ".$_POST['chrCalendarType'];
	 }
