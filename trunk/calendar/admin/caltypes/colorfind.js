...
function close_colorfind() {
	...
	document.getElementById('preview').style.color = document.getElementById('chrColorText').value;
	document.getElementById('preview').style.backgroundColor = document.getElementById('chrColorBG').value;
}
