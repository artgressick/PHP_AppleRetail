<?
	...
	list($mysqlStr,$audit) = set_strs($mysqlStr,'chrNSOTask',$info['chrNSOTask'],$audit,$table,$info['ID']);
	...
	if($mysqlStr != '') { 
		$_SESSION['infoMessages'][] = $_POST['chrNSOTask']." has been successfully updated in the Database.";
		list($str,$aud) = update_record($mysqlStr, $audit, $table, $info['ID']);
	 } else {
	 	$_SESSION['infoMessages'][] = "No Changes have been made to ".$_POST['chrNSOTask'];
	 }
