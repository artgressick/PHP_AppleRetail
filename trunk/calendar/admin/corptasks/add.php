...
<?=form_select($results,array('caption'=>'Event Types','name'=>'idNSOType','required'=>'true'))?>

													<div style='margin-top: 10px;'>
													<?=form_text(array('caption'=>'Corporate Partner Task Name','required'=>'true','name'=>'chrNSOCorpTask','size'=>'35','maxlength'=>'120'))?>
													</div>
												</td>
