...
<?=form_select($results,array('caption'=>'Event Types','name'=>'idNSOType','required'=>'true','value'=>$info['idNSOType']))?>

													<div style='margin-top: 10px;'>
													<?=form_text(array('caption'=>'Corporate Partner Task Name','required'=>'true','name'=>'chrNSOCorpTask','size'=>'35','maxlength'=>'120','value'=>$info['chrNSOCorpTask']))?>
													</div>
												</td>
