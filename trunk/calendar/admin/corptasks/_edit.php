<?
	...
	list($mysqlStr,$audit) = set_strs($mysqlStr,'chrNSOCorpTask',$info['chrNSOCorpTask'],$audit,$table,$info['ID']);
	...
	if($mysqlStr != '') { 
		$_SESSION['infoMessages'][] = $_POST['chrNSOCorpTask']." has been successfully updated in the Database.";
		list($str,$aud) = update_record($mysqlStr, $audit, $table, $info['ID']);
	 } else {
	 	$_SESSION['infoMessages'][] = "No Changes have been made to ".$_POST['chrNSOCorpTask'];
	 }
