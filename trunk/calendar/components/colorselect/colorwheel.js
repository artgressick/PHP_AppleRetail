...
function InitializeColorWheel()
{
  if (!((browser.isIE55 || browser.isIE6up) && browser.isWin32)) {
     ...
     thesmartversion = "<a href='javascript://' onclick='javascript:pickColor(); return false;'><img src='" + BF + "calendar/components/colorselect/hsvwheel.png' alt='color wheel' width='553' height='257' border='0'></a>";
