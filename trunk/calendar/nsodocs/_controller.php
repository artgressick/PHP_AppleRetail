<?
	...
	switch($file_name) {
		...
		case 'index.php':
			...
			$results = db_query('SELECT CalendarFiles.ID,CalendarFiles.chrKEY, chrFileTitle, chrCalendarFile,chrNSOFileGroup, RetailStores.chrName as chrStore,
			...
			$title = "NSO/Remodel Documents";						# Page Title
			$directions = 'Please choose one of the documents from the list below to see it.';

			$header_title = "NSO & Remodel Documents <span class='resultsShown'>(<span id='resultCount'>".mysqli_num_rows($results)."</span> results)</span>";
