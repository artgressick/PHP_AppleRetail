							...
							<tr>
								<td width="196" valign="top">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td height="24" style="background: url(<?=$BF?>images/email_bottomfooter.gif); text-align:center; font-size: 12px; font-weight:bold;">Site Tour</td>
										</tr>
										<tr>
...
if(access_check(2,5)) {
?>
												<div class="web_page_parent" style="padding:5px 0px 0px 5px;"><a href="<?=$BF?>calendar/learn/search.php" style = "color: #0000FF; text-decoration: none; vertical-align:top;"><strong>Search Articles</strong></a></div>
<?
}
