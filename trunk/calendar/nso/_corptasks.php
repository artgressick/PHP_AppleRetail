<?
	...
	if($mysqlStr != '') { 
		$_SESSION['infoMessages'][] = $info['chrNSOCorpTask']." has been successfully updated in the Database.";
		...
		db_query("UPDATE NSOs SET dtUpdated=now() WHERE ID=".$info['idNSO'],"Updating Timestamp for NSO");
	 	...
	 	$_SESSION['infoMessages'][] = "No Changes have been made to ".$info['chrNSOCorpTask'];
	 }
