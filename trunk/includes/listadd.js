...
function list_add(table_id, field_id, field_chr, item_id, item_chr)
{
	...
	td.innerHTML= "<div class='deleteImage' onmouseover='document.getElementById("+'"'+"deleteButton"+ item_id +'").src="'+BF+'images/button_delete_on.png"'+"' "+
	"onmouseout='document.getElementById("+'"deleteButton'+item_id+'").src="'+BF+'images/button_delete.png"'+"' "+
	'onclick="list_remove('+"'Contacts', 'idContacts', 'chrContacts',"+item_id+", this);repaint('Contacts')"+'">'+
	'<img id='+"'deleteButton"+ item_id +"' src='"+BF+"images/button_delete.png' alt='delete button' /></div>";
	row.appendChild(td);
