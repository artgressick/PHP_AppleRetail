...
function show_colorfind(field) {
	...
	colorfinder['rainbow'].style.top = '75px';
	...
	colorfinder['endcolor'].style.top = '193px';
	...
	colorfinder['picker'].style.top = '116px';
	...
	colorfinder['picker_img'].style.top = '116px';
	colorfinder['picker_img'].style.left = '128px';
	...
	colorfinder['ok'].style.top = '254px';
	...
	colorfinder['exit'].style.top = '377px';
