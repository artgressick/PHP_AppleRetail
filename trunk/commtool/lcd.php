<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Problem Explanation:||| ".encode($_POST['Notes']).":::";
				$msg = encode($msg);
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); ?>
					...
					<tr>
						<td colspan="3">
							<div class='FormName'>Problem Explanation <span class='FormRequired'>(Required) (You can enter other notes in this box)</span></div>
