...
/*
					<tr>
						<td class="left">
							<div class='FormName'>Field 1 text</div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrField1" id="chrField1" maxlength="50" /></div>
						</td>
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>Field 2 text <span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrField2" id="chrField2" maxlength="50" ></div>
						</td>
					</tr>
*/
// OUTPUT TO SCREEN
