<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Transaction Amount:||| ".encode($_POST['chrDoubleAmount']).":::
...
?>
	...
	<script language="javascript">
		function error_check() {
			...
			total += ErrorCheck('chrDoubleAmount', "You must enter a Transaction Amount.");
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); //Table started here, 3 columns wide. ?>
					...
					<tr>
						...
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>Customer Credit Card Number (Last Four Digits) <span class='FormRequired'>(Required)</span></div>
					...
					<tr>
						<td>
							<div class='FormName'>Transaction Amount <span class='FormRequired'>(Required)</span></div> 
