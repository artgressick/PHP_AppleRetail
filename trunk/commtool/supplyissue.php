<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Staples Issue:||| ".encode($_POST['chrStaples']).":::
		<br /><br />MCM Issue:||| ".encode($_POST['chrMCM']).":::
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); ?>
					...
					<tr>
						<td class="left">
							<div class='FormName'>Staples Issue <span class='FormRequired'></span></div>
							<div class='FormField'><textarea class="FormTextArea" name="chrStaples" id="chrStaples" rows="10" wrap="virtual"></textarea></div>
						</td>
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>MCM Issue <span class='FormRequired'></span></div>
