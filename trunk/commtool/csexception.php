<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Your Name:||| ".encode($_POST['chrName']).":::
		<br /><br />POS Transaction Number:||| ".encode($_POST['chrPOS']).":::
		<br /><br />Expected Cash Variance:||| ".encode($_POST['chrAmount']).":::
		<br /><br />Description of the Issue:||| ".encode($_POST['Notes']).":::";
				$msg = encode($msg);
...
?>
	...
	<script language="javascript">
		function error_check() {
			...
			total += ErrorCheck('chrAmount', "You must enter a Cash Variance.");
			total += ErrorCheck('chrPOS', "You must enter a Transaction Number.");
			total += ErrorCheck('Notes', "You must enter a Description.");
	...
	include($BF. "commtool/includes/top_email.php"); ?>
					...
					<tr>
						<td class="left">
							...
							<div class='FormField'><input class="FormTextBox" type="text" name="chrName" id="chrName" maxlength="50" /></div>
						</td>
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>POS Transaction Number <span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrPOS" id="chrPOS" maxlength="50" /></div>
						</td>
					</tr>
					<tr>
						<td>
							<div class='FormName'>Expected Cash Variance <span class='FormRequired'>(Required)</span></div> 
							<div class='FormField'><input class="FormTextBoxSingle" type="text" name="chrAmount" id="chrAmount" maxlength="50" /></div>
						</td>
						<td class="gutter"></td>
						<td class="right"></td>
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>Description of the Issue <span class='FormRequired'>(Required) (You can enter other notes in this box)</span></div>
