	...
	<td colspan="3" class="emailbody">
			...
			<!-- This is the main page form -->
				...
				<table width="100%" class="twoCol" id="twoCol" cellpadding="0" cellspacing="0">
					<tr>
						<td class="left">
							<div class='FormName'>Numero del negozio <span class='FormRequired'>(obbligatorio)</span></div>
						...
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>Nome del neogzio <span class='FormRequired'>(obbligatorio)</span></div>
