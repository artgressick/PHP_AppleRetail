	...
	<td colspan="3" class="emailbody">
			...
			<!-- This is the main page form -->
				...
				<table width="100%" class="twoCol" id="twoCol" cellpadding="0" cellspacing="0">
					<tr>
						<td class="left">
							<div class='FormName'>Numéro de boutique <span class='FormRequired'>(requis)</span></div>
						...
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>Nom de la boutique <span class='FormRequired'>(requis)</span></div>
