...
// END DO NOT EDIT
		...
		<br /><br />Standard Business Hours (Monday):||| ".encode($_POST['chrThurs']).":::
		<br /><br />Holiday Business Hours (Labor Day):||| ".encode($_POST['chrHol']).":::";
// DO NOT EDIT
		$msg = encode($msg);
...
?>
	...
	<script language="javascript">
		function error_check() {
			...
			total += ErrorCheck('chrHol', "You must answer the question to submit this template.");
...
?>
					<tr>
						<td class="left">
							<div class='FormName'>Standard Business Hours (Monday)<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrThurs" id="chrThurs" rows="10" wrap="virtual"></textarea></div>
						</td>
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>Holiday Business Hours (Labor Day)<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrHol" id="chrHol" rows="10" wrap="virtual"></textarea></div>
						</td>
					</tr>
<?
