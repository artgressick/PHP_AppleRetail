<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Are you attending the Meet and Greet?||| ".$_POST['bBelow1'].":::
		<br /><br />Are you attending General Session 1?||| ".$_POST['bBelow2'].":::
		<br /><br />Are you attending the Tradeshows and Bubb Road Lunch?||| ".$_POST['bBelow3'].":::
		<br /><br />Are you attending General Session 2?||| ".$_POST['bBelow4'].":::
		<br /><br />Are you attending the Breakout Discussions 1?||| ".$_POST['bBelow5'].":::
		<br /><br />Are you attending the Retail Team Dinner?||| ".$_POST['bBelow6'].":::
		<br /><br />Are you attending General Session 3 and Lunch?||| ".$_POST['bBelow7'].":::
		<br /><br />Are you attending the Breakout Discussions 2?||| ".$_POST['bBelow8'].":::";
		$msg = encode($msg);
	...
	<script language="javascript">
		function error_check() {
			...
			if (document.getElementById('chrCC').value != '') { 
				total += ErrorCheck("chrCC","You must enter a valid Apple Email address","apple_email");
			}
			...
			if (!document.forms[0].bBelow6[0].checked && !document.forms[0].bBelow6[1].checked) {
			total += CustomError("You must indicate whether you are attending each of the events.");
			}
			
			if (!document.forms[0].bBelow7[0].checked && !document.forms[0].bBelow7[1].checked) {
			total += CustomError("You must indicate whether you are attending each of the events.");
			}
			
			if (!document.forms[0].bBelow8[0].checked && !document.forms[0].bBelow8[1].checked) {
			total += CustomError("You must indicate whether you are attending each of the events.");
			}
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); //Table started here, 3 columns wide. ?>
					...
					<tr>
						<td colspan="3">
							<div class='FormName'>Are you attending the Meet and Greet?<span class='FormRequired'>(Required)</span></div> 
					...
					<tr>
						<td colspan="3">
							<div class='FormName'>Are you attending the Breakout Discussions 1?<span class='FormRequired'>(Required)</span></div> 
					...
					<tr>
						<td colspan="3">
							<div class='FormName'>Are you attending the Retail Team Dinner?<span class='FormRequired'>(Required)</span></div> 
							<div class='FormField'><input type="radio" name="bBelow6" id="bBelow6" value="Yes" /> Yes &nbsp; <input type="radio" name="bBelow6" id="bBelow6" value="No" /> No</div>
						</td>
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>Are you attending General Session 3?<span class='FormRequired'>(Required)</span></div> 
							<div class='FormField'><input type="radio" name="bBelow7" id="bBelow7" value="Yes" /> Yes &nbsp; <input type="radio" name="bBelow7" id="bBelow7" value="No" /> No</div>
						</td>
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>Are you attending the Breakout Discussions 2?<span class='FormRequired'>(Required)</span></div> 
							<div class='FormField'><input type="radio" name="bBelow8" id="bBelow8" value="Yes" /> Yes &nbsp; <input type="radio" name="bBelow8" id="bBelow8" value="No" /> No</div>
						</td>
					</tr>
<?
