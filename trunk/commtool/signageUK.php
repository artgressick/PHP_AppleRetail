<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Sign Location Number:||| ".encode($_POST['chrAmount']).":::
		<br /><br />Requested Action:||| ".encode($_POST['Notes']).":::";
				$msg = encode($msg);
...
?>
	...
	<script language="javascript">
		function error_check() {
			...
			total += ErrorCheck('chrPOS', "You must enter aa Employee Name.");
			total += ErrorCheck('chrAmount', "You must enter a Sign Location Number.");
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); ?>
					...
					<tr>
						...
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>Sign Location Number <span class='FormRequired'>(Required)</span></div>
