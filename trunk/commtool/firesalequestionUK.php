<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Firesale Question:||| ".encode($_POST['chrFiresale']).":::
		<br /><br />Refresg List Question:||| ".encode($_POST['chrRefresh']).":::";
				$msg = encode($msg);
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); ?>
					...
					<tr>
						<td>
							<div class='FormName'>Firesale Question</div> 
							<div class='FormField'><input class="FormTextBox" type="text" name="chrFiresale" id="chrFiresale" maxlength="50" /></div>
						</td>
						<td class="gutter"></td>
						<td class="right"></td>						
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>Refresh List Question <span class='FormRequired'>(You can enter other notes in this box)</span></div>
							<div class='FormField'><textarea class="FormTextArea" name="chrRefresh" id="chrRefresh" rows="20" wrap="virtual"></textarea></div>
						</td>
					</tr>
