<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Explaination of FOH demo image issue:||| ".encode($_POST['chrFiresale']).":::
		<br /><br />Requested Action to be Taken:||| ".encode($_POST['chrRefresh']).":::";
				$msg = encode($msg);
...
?>
	...
	<script language="javascript">
		function error_check() {
			...
			total += ErrorCheck('chrFiresale', "You must enter a Explanation.");
			total += ErrorCheck('chrRefresh', "You must enter a Requested Action.");
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); ?>
					...
					<tr>
						<td class="left">
							<div class='FormName'>Explanation of the Image issue <span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><textarea class="FormTextArea" name="chrFiresale" id="chrFiresale" rows="10" wrap="virtual"></textarea></div>
						</td>
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>Requested Action <span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><textarea class="FormTextArea" name="chrRefresh" id="chrRefresh" rows="10" wrap="virtual"></textarea></div>
						</td>
					</tr>
