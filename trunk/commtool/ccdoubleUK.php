<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Date of Occurence:||| ".encode($_POST['chrDate']).":::
		<br /><br />Credit Card Number (Last Four Digits):||| ".encode($_POST['chrCCNumber']).":::
		<br /><br />Invalid/Valid Transaction Number:||| ".encode($_POST['chrOverAmount']).":::
		<br /><br />Customer Name:||| ".encode($_POST['chrAmount']).":::
		<br /><br />Double Charge Amount:||| ".encode($_POST['chrDoubleAmount']).":::
		<br /><br />Explanation:||| ".encode($_POST['Notes']).":::";
		$msg = encode($msg);
...
?>
	...
	<script language="javascript">
		function error_check() {
			...
			total += ErrorCheck('chrCCNumber', "You must enter a Credit Card Number.");
			total += ErrorCheck('chrDoubleAmount', "You must enter a Double Charge Amount.");
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); //Table started here, 3 columns wide. ?>
					...
					<tr>
						<td class="left">
							<div class='FormName'>Date of Occurence</div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrDate" id="chrDate" maxlength="50" /></div>
						</td>
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>Credit Card Number (Last Four Digits)<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrCCNumber" id="chrCCNumber" maxlength="4" ></div>
						</td>
					</tr>
					<tr>
						<td class="left">
							<div class='FormName'>Invalid/Valid Transaction Number</div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrOverAmount" id="chrOverAmount"  maxlength="50" /></div>
						</td>
						<td class="gutter"></td>
						<td class="right">
					...
					<tr>
						<td>
							<div class='FormName'>Double Charge Amount <span class='FormRequired'>(Required)</span></div> 
							<div class='FormField'><input class="FormTextBox" type="text" name="chrDoubleAmount" id="chrDoubleAmount" maxlength="50" /></div>
						</td>
						<td class="gutter"></td>
						<td class="right"></td>						
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>Explanation <span class='FormRequired'>(You can enter other notes in this box)</span></div>
