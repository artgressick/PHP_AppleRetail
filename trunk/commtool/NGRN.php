<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Additional Network Racks present other than the main rack?||| ".$_POST['bBelow'].":::
		<br /><br />If Yes, number of additional racks:||| ".encode($_POST['chrCheckAmount']).":::
		<br /><br />If yes, location(s) of additional racks:||| ".encode($_POST['chrTransNum']).":::
		<br /><br />If yes, Orange fibre cable present on back of rack (answer for each location):||| ".encode($_POST['chrCustName']).":::
		<br /><br />Additional Comments:||| ".nl2br(encode($_POST['Notes'])).":::";
		$msg = encode($msg);
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); //Table started here, 3 columns wide. ?>
					...
					<tr>
						<td colspan="3">
							<div class='FormName'>Additional Network Racks present other than the main rack?<span class='FormRequired'>(Required)</span></div> 
					...
					<tr>
						<td colspan="3">
							<div class='FormName'>If Yes, number of additional racks<span class='FormRequired'></span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrCheckAmount" id="chrCheckAmount"  maxlength="50" /></div>
						</td>
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>If yes, location(s) of additional racks<span class='FormRequired'></span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrTransNum" id="chrTransNum"  maxlength="50" /></div>
						</td>
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>If yes, Orange fibre cable present on back of rack (answer for each location)<span class='FormRequired'>(Required)</span></div> 
							<div class='FormField'><input class="FormTextBox" type="text" name="chrCustName" id="chrCustName" maxlength="50" /></div>
						</td>
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>Additional Comments <span class='FormRequired'></span></div>
