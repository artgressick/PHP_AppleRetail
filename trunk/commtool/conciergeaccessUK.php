<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Employee's Name:||| ".encode($_POST['chrEmployeeName']).":::
		<br /><br />Employee Number:||| ".encode($_POST['chrEmployeeNumber']).":::
		<br /><br />Role in Merlin:||| ".encode($_POST['Notes']).":::";
				$msg = encode($msg);
...
?>
	...
	<script language="javascript">
		function error_check() {
			...
			total += ErrorCheck('Notes', "You must enter a Role in Merlin.");
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); ?>
					...
					<tr>
						<td colspan="3">
							<div class='FormName'>Role in Merlin <span class='FormRequired'>(Required) (You can enter other notes in this box)</span></div>
