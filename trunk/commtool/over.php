...
// END DO NOT EDIT
		...
		<br /><br />Did the store(s) you were in run out of phones? What time?:||| ".encode($_POST['chrOut']).":::
		<br /><br />Approximately how many iPhone have been sold?:||| ".encode($_POST['chrSold']).":::
		<br /><br />What questions do you have now that the Event is over?:||| ".encode($_POST['chrOver']).":::";
// DO NOT EDIT
		$msg = encode($msg);
...
?>
					...
					<tr>
						<td colspan="3">
							<div class='FormName'>Did the store(s) you were in run out of phones? What time?<span class='FormRequired'>(Required)</span></div>
					...
					<tr>
						<td colspan="3">
							<div class='FormName'>What questions do you have now that the Event is over?<span class='FormRequired'>(Required)</span></div>
