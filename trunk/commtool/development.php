<?php
	...
	if(count($_POST)) { // When doing isset, use a required field.  Faster than the php count funtion.
		...
		<br /><br />Employees's Name:||| ".encode($_POST['chrEmployee']).":::
...
?>
	...
	<script language="javascript">
		function error_check() {
			...
			total += ErrorCheck('chrEmployee', "You must enter a Employee Name.");
			total += ErrorCheck('Notes', "You must enter a Store Name.");
