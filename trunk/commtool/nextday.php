...
// END DO NOT EDIT
		...
		<br /><br />What were the biggest challenges with this event?:||| ".encode($_POST['chrBigg']).":::
		<br /><br />What were the biggest wins?:||| ".encode($_POST['chrWins']).":::
		<br /><br />How many people were in line at 9:00 a.m. this morning?:||| ".encode($_POST['chrVisit']).":::
		<br /><br />How long did the line last?:||| ".encode($_POST['chrLast']).":::
		<br /><br />Did the store(s) run out of phones? What time?:||| ".encode($_POST['chrOut']).":::
		<br /><br />What are customers saying about the product?:||| ".encode($_POST['chrSold']).":::
		<br /><br />What iPhone feedback do you have overall?:||| ".encode($_POST['chrOver']).":::";
// DO NOT EDIT
		$msg = encode($msg);
...
// ERROR CHECK
		...
		total += ErrorCheck('chrBigg', "You must answer the question to submit this survey.");
		total += ErrorCheck('chrWins', "You must answer the question to submit this survey.");
		total += ErrorCheck('chrLast', "You must answer the question to submit this survey.");
		total += ErrorCheck('chrOut', "You must answer the question to submit this survey.");
		total += ErrorCheck('chrSold', "You must answer the question to submit this survey.");
		total += ErrorCheck('chrOver', "You must answer the question to submit this survey.");
// END ERROR CHECK
...
?>
					<tr>
						<td colspan="3">
							<div class='FormName'>What were the biggest challenges with this event?<span class='FormRequired'>(Required)</span></div>
					...
					<tr>	
						<td colspan="3">
							<div class='FormName'>How many people were in line at 9:00 a.m. this morning?<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><textarea class="FormTextArea" name="chrWins" id="chrWins" rows="10" wrap="virtual"></textarea></div>
						</td>
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>How long did the line last?<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><textarea class="FormTextArea" name="chrLast" id="chrLast" rows="10" wrap="virtual"></textarea></div>
						</td>
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>Did the store(s) run out of phones? What time?<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><textarea class="FormTextArea" name="chrOut" id="chrOut" rows="10" wrap="virtual"></textarea></div>
						</td>
					</tr>
					<tr>	
						<td colspan="3">
							<div class='FormName'>What are customers saying about the product?<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><textarea class="FormTextArea" name="chrSold" id="chrSold" rows="10" wrap="virtual"></textarea></div>
						</td>
					</tr>
					<tr>
						<td colspan="3">
							<div class='FormName'>What iPhone feedback do you have overall?<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><textarea class="FormTextArea" name="chrOver" id="chrOver" rows="10" wrap="virtual"></textarea></div>
						</td>
					</tr>
<?
