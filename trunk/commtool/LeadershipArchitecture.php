<?php
	...
	$info = database_query("SELECT chrRFLName,txtInstructions FROM RFLEmails WHERE ID=". $_REQUEST['id'],"getting email info",1);
	...
	/*  This is the query to get the distro list for the current e-mail.*/
		...
		WHERE RFLEmails.ID=".$_REQUEST['id']." AND !RFLContacts.bDeleted";	
...
<?	include($BF. "includes/top.php");
	...
	include($BF. "commtool/includes/top_email.php"); ?>
					...
					<tr>
						<td class="left">
							<div class='FormName'>Red Zone<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrPOS" id="chrPOS" maxlength="100" /></div>
						</td>
						<td class="gutter"></td>
						<td class="right">
							<div class='FormName'>Family Room <span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrAmount" id="chrAmount" maxlength="100" /></div>
						</td>
					</tr>
					<tr>
						<td class="left">
							<div class='FormName'>Operations<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrPOS" id="chrPOS" maxlength="100" /></div>
						</td>
                        <td class="gutter"></td>
						<td class="right">
							<div class='FormName'>People<span class='FormRequired'>(Required)</span></div>
							<div class='FormField'><input class="FormTextBox" type="text" name="chrAmount" id="chrAmount" maxlength="100" /></div>
						</td>
					</tr>
